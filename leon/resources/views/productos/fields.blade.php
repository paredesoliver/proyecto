...
<div class="col-sm-6">
    ...
    {!! Form::text('codigo', null, ['class' => 'form-control','maxlength' => 20,'maxlength' => 20,'required'=>'required']) !!}
</div>
...
<div class="col-sm-6">
    ...
    {!! Form::text('unidad_medida', null, ['class' => 'form-control','maxlength' => 50,'maxlength' => 50,'required'=>'required']) !!}
</div>
