...
<h1>Empresa:  {{$facturas->sitio_web}}</h1>
...
<strong>Correo empresarial:  {{$facturas->correo}}</strong>

<div style="margin-left: 400px;">
    <div style="background:#734D45;color:white;margin-top:10px;width: 300px;">
...
<div>
    <div style="background:#734D45;color:white;margin-top:10px;width: 300px;text-align:center;">
...
<table style="margin-top:20px;width:100%;">
    <tr style="background:#734D45;color:white">
        <th>Nº</th>
        <th>Cantidad</th>
        <th>Descripcion</th>
